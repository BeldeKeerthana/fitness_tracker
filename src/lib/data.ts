...
export const yogaPoses: YogaPose[] = [
  { id: 'mountain-pose', title: 'Mountain Pose (Tadasana)', level: 'Basic', benefits: ['Improves posture', 'Strengthens thighs, knees, and ankles', 'Firms abdomen and buttocks'], videoUrl: 'https://www.youtube.com/embed/LNillCnfL24', image: { id: 'yoga-mountain', url: getImageUrl('yoga-mountain')?.imageUrl ?? '', hint: getImageUrl('yoga-mountain')?.imageHint ?? '' } },
  { id: 'downward-dog', title: 'Downward-Facing Dog (Adho Mukha Svanasana)', level: 'Basic', benefits: ['Energizes the body', 'Stretches the shoulders, hamstrings, calves, arches, and hands', 'Strengthens the arms and legs'], videoUrl: 'https://www.youtube.com/embed/ECeja1ksA-g', image: { id: 'yoga-downward-dog', url: getImageUrl('yoga-downward-dog')?.imageUrl ?? '', hint: getImageUrl('yoga-downward-dog')?.imageHint ?? '' } },
  { id: 'warrior-2', title: 'Warrior II (Virabhadrasana II)', level: 'Basic', benefits: ['Stretches and strengthens the legs and ankles', 'Stretches the groins, chest, and shoulders', 'Increases stamina'], videoUrl: 'https://www.youtube.com/embed/k4qaVoAbeHM', image: { id: 'yoga-warrior-2', url: getImageUrl('yoga-warrior-2')?.imageUrl ?? '', hint: getImageUrl('yoga-warrior-2')?.imageHint ?? '' } },
  { id: 'tree-pose', title: 'Tree Pose (Vrikshasana)', level: 'Basic', benefits: ['Improves balance and stability', 'Strengthens the legs and core', 'Opens the hips'], videoUrl: 'https://www.youtube.com/embed/Fr5kiIyg-9w', image: { id: 'yoga-tree', url: getImageUrl('yoga-tree')?.imageUrl ?? '', hint: getImageUrl('yoga-tree')?.imageHint ?? '' } },
  { id: 'bridge-pose', title: 'Bridge Pose (Setu Bandhasana)', level: 'Basic', benefits: ['Stretches the chest, neck, and spine', 'Calms the brain and helps alleviate stress', 'Stimulates abdominal organs, lungs, and thyroid'], videoUrl: 'https://www.youtube.com/embed/N-5IdM4p-b4', image: { id: 'yoga-bridge', url: getImageUrl('yoga-bridge')?.imageUrl ?? '', hint: getImageUrl('yoga-bridge')?.imageHint ?? '' } },
